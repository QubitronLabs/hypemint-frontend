        ...
        <div className="max-w-4xl mx-auto p-6">
            ...
            >
                <div className="flex items-center gap-4">
                    <Avatar className="w-20 h-20 border-2 border-border">
                        <AvatarImage src={user.avatarUrl || undefined} alt={displayName || shortAddress} />
                ...
                {!isOwnProfile && isAuthenticated && (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        animate={{
                            backgroundColor: localIsFollowing ? 'transparent' : 'var(--primary)',
                        }}
            ...
            >
                <div className="text-center">
                    <p className="text-2xl font-bold tabular-nums">{user.followersCount}</p>
                    <p className="text-sm text-muted-foreground">Followers</p>
                </div>
                <div className="text-center">
                    <p className="text-2xl font-bold tabular-nums">{user.followingCount}</p>
                    <p className="text-sm text-muted-foreground">Following</p>
                </div>
                <div className="text-center">
                    <p className="text-2xl font-bold tabular-nums">{user.tokensCreated}</p>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <Avatar className="w-10 h-10">
                                                ...
                                                <AvatarFallback className="bg-primary/20">
                                                    {(follower.displayName || follower.username || '?').slice(0, 2)}
                                                </AvatarFallback>
                                            </Avatar>
                                            <div>
                                                <p className="font-medium">
                                                    {follower.displayName || follower.username || `${follower.walletAddress.slice(0, 6)}...${follower.walletAddress.slice(-4)}`}
                                                </p>
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <Avatar className="w-10 h-10">
                                                ...
                                                <AvatarFallback className="bg-primary/20">
                                                    {(following.displayName || following.username || '?').slice(0, 2)}
                                                </AvatarFallback>
                                            </Avatar>
                                            <div>
                                                <p className="font-medium">
                                                    {following.displayName || following.username || `${following.walletAddress.slice(0, 6)}...${following.walletAddress.slice(-4)}`}
                                                </p>
                                                <p className="text-xs text-muted-foreground">
