                                ...
                                <div className="bg-card border border-border rounded-xl p-6">
                                    {holders.length > 0 ? (
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-muted-foreground">
                                                                {parseFloat(holder.balance || '0').toLocaleString()} tokens
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-muted-foreground">No holders data available yet</p>
                ...
                <div className="space-y-6">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="font-semibold text-sm">Token Info</span>
                        </div>
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <span className="text-xs text-muted-foreground">Total Supply</span>
                                <span className="text-sm font-mono tabular-nums">
                                    {parseFloat(token.totalSupply || '1000000000').toLocaleString()}
                                </span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-xs text-muted-foreground">Circulating</span>
                                <span className="text-sm font-mono tabular-nums">
                                    {parseFloat(token.circulatingSupply || '0').toLocaleString()}
                                </span>
                            </div>
                            <div className="flex items-center justify-between">
                                    ...
                                    <div className="border-t border-border pt-3 mt-3">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 text-xs">
                                            <div className="bg-muted/50 rounded-lg p-2">
                                                <p className="text-muted-foreground">Max Wallet</p>
                                                <p className="font-medium">2%</p>
                                            </div>
                                            <div className="bg-muted/50 rounded-lg p-2">
                                                <p className="text-muted-foreground">Snipe Protection</p>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="bg-muted/30 rounded-lg p-3 text-center">
                                <p className="text-2xl font-bold tabular-nums">{token.holdersCount ?? 0}</p>
                                <p className="text-xs text-muted-foreground">Holders</p>
                            </div>
                            <div className="bg-muted/30 rounded-lg p-3 text-center">
                                <p className="text-2xl font-bold tabular-nums">{token.tradesCount ?? 0}</p>
                                <p className="text-xs text-muted-foreground">Trades</p>
                            </div>
                        </div>
                    </motion.div>
