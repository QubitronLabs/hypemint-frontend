  ...
  const handleWebSocketMessage = useCallback(
    (message: any) => {
      if (
        ...
        queryClient.invalidateQueries({ queryKey: tradeKeys.byToken(id) });
        ...
        queryClient.invalidateQueries({ queryKey: tokenKeys.holders(id) });
      }
      if (
        ...
        queryClient.setQueryData(
          ...
          (oldData: Token | undefined) => {
            ...
            return {
              ...
              priceChange24h:
                message.data.priceChange24h ?? oldData.priceChange24h,
              // Update tradesCount in real-time
              tradesCount: message.data.tradesCount ?? oldData.tradesCount,
            };
          },
        );
      }
        ...
        <div className="space-y-6 ">
          ...
          >
            <Tabs
              value={activeTab}
              onValueChange={(value) =>
                setActiveTab(value as "trades" | "comments" | "holders")
              }
            >
