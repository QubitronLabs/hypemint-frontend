...
import { cn, fromWei, formatNumber, formatCurrency } from "@/lib/utils";
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          Connect your wallet to view your portfolio, holdings, and transaction
          history
        </p>
      </div>
    );
                ...
                {holdings.map((holding, index) => (
                  ...
                  >
                    ...
                    <div className="text-right text-sm text-muted-foreground">
                      {holding.lastTrade
                        ? formatRelativeTime(holding.lastTrade)
                        : "-"}
                    </div>
                  </Link>
                ))}
                ...
                {userTrades.slice(0, 50).map((trade) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      >
                        {trade.type === "buy" ? "+" : "-"}
                        {formatNumber(fromWei(trade.amount))}
                      </p>
                    </div>

                    <div className="text-right">
                      <p className="font-medium tabular-nums text-sm">
                        ${fromWei(trade.price).toFixed(8)}
                      </p>
                    </div>

                    <div className="text-right">
                      <p className="font-medium tabular-nums text-sm">
                        {formatCurrency(fromWei(trade.totalValue))}
                      </p>
                    </div>
