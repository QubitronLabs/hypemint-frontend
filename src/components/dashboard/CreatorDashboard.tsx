      ...
      >
        <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            {createdTokens.length === 0 ? (
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {createdTokens.map((token) => (
                  <TokenCreatorCard key={token.id} token={token} />
                ))}
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="earnings" className="space-y-4">
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium">How Creator Fees Work</span>
                </div>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• You earn 1% of every trade on your tokens</li>
                  <li>• Fees accumulate in the bonding curve contract</li>
                  <li>• Claim your earnings anytime (gas fees apply)</li>
            ...
            {/* Earnings by Token */}
            <div className="bg-card border border-border rounded-xl p-4">
              <h3 className="font-semibold mb-4">Earnings by Token</h3>
              {createdTokens.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
